...
*/
extern void ej7_opSelectCookType( Ej7* handle, const sc_integer type);
extern void ej7_opStartCooking( Ej7* handle);
extern void ej7_opStopCooking( Ej7* handle);
extern void ej7_opLED( Ej7* handle, const sc_integer LEDNumber, const sc_boolean State);
