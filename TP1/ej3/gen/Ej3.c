...
static sc_boolean check_forma_WAIT_SELEC_FORMA_tr0_tr0(const Ej3* handle);
static sc_boolean check_forma_FORMA_SELECCIONADA_tr0_tr0(const Ej3* handle);
static sc_boolean check_forma_SELECC_FORMA_tr0_tr0(const Ej3* handle);
static sc_boolean check_forma_SELECC_FORMA_tr1_tr1(const Ej3* handle);
static sc_boolean check_magnitud_FRECUENCIA_tr0_tr0(const Ej3* handle);
static sc_boolean check_magnitud_FRECUENCIA_tr1_tr1(const Ej3* handle);
static sc_boolean check_magnitud_TENSION_tr0_tr0(const Ej3* handle);
static sc_boolean check_magnitud_TENSION_tr1_tr1(const Ej3* handle);
...
static sc_boolean check_magnitud_LED_FREC_tr0_tr0(const Ej3* handle);
static sc_boolean check_magnitud_LED_VOLTAGE_tr0_tr0(const Ej3* handle);
...
static void effect_forma_WAIT_SELEC_FORMA_tr0(Ej3* handle);
static void effect_forma_FORMA_SELECCIONADA_tr0(Ej3* handle);
static void effect_forma_SELECC_FORMA_tr0(Ej3* handle);
static void effect_forma_SELECC_FORMA_tr1(Ej3* handle);
static void effect_magnitud_FRECUENCIA_tr0(Ej3* handle);
static void effect_magnitud_FRECUENCIA_tr1(Ej3* handle);
static void effect_magnitud_TENSION_tr0(Ej3* handle);
static void effect_magnitud_TENSION_tr1(Ej3* handle);
...
static void effect_magnitud_LED_FREC_tr0(Ej3* handle);
static void effect_magnitud_LED_VOLTAGE_tr0(Ej3* handle);
...
static void enact_forma_WAIT_SELEC_FORMA(Ej3* handle);
...
static void enact_magnitud_LED_FREC(Ej3* handle);
static void enact_magnitud_LED_VOLTAGE(Ej3* handle);
...
static void exact_magnitud_LED_FREC(Ej3* handle);
static void exact_magnitud_LED_VOLTAGE(Ej3* handle);
...
static void enseq_forma_WAIT_SELEC_FORMA_default(Ej3* handle);
static void enseq_forma_FORMA_SELECCIONADA_default(Ej3* handle);
static void enseq_forma_SELECC_FORMA_default(Ej3* handle);
...
static void enseq_magnitud_LED_FREC_default(Ej3* handle);
static void enseq_magnitud_LED_VOLTAGE_default(Ej3* handle);
...
static void exseq_forma_WAIT_SELEC_FORMA(Ej3* handle);
static void exseq_forma_FORMA_SELECCIONADA(Ej3* handle);
static void exseq_forma_SELECC_FORMA(Ej3* handle);
...
static void exseq_magnitud_LED_FREC(Ej3* handle);
static void exseq_magnitud_LED_VOLTAGE(Ej3* handle);
...
static void react_forma_WAIT_SELEC_FORMA(Ej3* handle);
static void react_forma_FORMA_SELECCIONADA(Ej3* handle);
static void react_forma_SELECC_FORMA(Ej3* handle);
...
static void react_magnitud_LED_FREC(Ej3* handle);
static void react_magnitud_LED_VOLTAGE(Ej3* handle);
...
const sc_integer EJ3_EJ3IFACE_LEDG = 1;
const sc_integer EJ3_EJ3IFACE_LEDB = 2;
...
void ej3_runCycle(Ej3* handle)
{
	...
	for (handle->stateConfVectorPosition = 0;
		...
		case Ej3_forma_WAIT_SELEC_FORMA:
		{
			react_forma_WAIT_SELEC_FORMA(handle);
			break;
		}
		...
		case Ej3_forma_SELECC_FORMA:
		{
			react_forma_SELECC_FORMA(handle);
			break;
		}
		...
		case Ej3_magnitud_LED_FREC:
		{
			react_magnitud_LED_FREC(handle);
			break;
		}
		case Ej3_magnitud_LED_VOLTAGE:
		{
			react_magnitud_LED_VOLTAGE(handle);
			break;
		}
		default:
			break;
...
sc_boolean ej3_isStateActive(const Ej3* handle, Ej3States state)
{
	...
	switch (state)
	{
		...
		case Ej3_forma_SENOIDAL :
			...
			break;
		case Ej3_forma_WAIT_SELEC_FORMA :
			result = (sc_boolean) (handle->stateConfVector[SCVI_EJ3_FORMA_WAIT_SELEC_FORMA] == Ej3_forma_WAIT_SELEC_FORMA
			);
			break;
		case Ej3_forma_FORMA_SELECCIONADA :
			...
			break;
		case Ej3_forma_SELECC_FORMA :
			result = (sc_boolean) (handle->stateConfVector[SCVI_EJ3_FORMA_SELECC_FORMA] == Ej3_forma_SELECC_FORMA
			);
			break;
		case Ej3_magnitud_FRECUENCIA :
		...
		case Ej3_magnitud_ELEGIR_AMPLITUD_VOLTAGE_r1_AMPLITUD_SELECCIONADA :
			...
			break;
		case Ej3_magnitud_LED_FREC :
			result = (sc_boolean) (handle->stateConfVector[SCVI_EJ3_MAGNITUD_LED_FREC] == Ej3_magnitud_LED_FREC
			);
			break;
		case Ej3_magnitud_LED_VOLTAGE :
			result = (sc_boolean) (handle->stateConfVector[SCVI_EJ3_MAGNITUD_LED_VOLTAGE] == Ej3_magnitud_LED_VOLTAGE
			);
			break;
		default:
			result = bool_false;
...
static void clearInEvents(Ej3* handle)
{
	...
	handle->timeEvents.ej3_magnitud_LED_FREC_tev0_raised = bool_false;
	handle->timeEvents.ej3_magnitud_LED_VOLTAGE_tev0_raised = bool_false;
}
...
const sc_integer ej3Iface_get_lEDG(const Ej3* handle)
{
	return EJ3_EJ3IFACE_LEDG;
}
const sc_integer ej3Iface_get_lEDB(const Ej3* handle)
{
	return EJ3_EJ3IFACE_LEDB;
}
...
static sc_boolean check_forma_TRIANGULAR_tr2_tr2(const Ej3* handle)
{
	return handle->internal.siForma_raised;
}
...
static sc_boolean check_magnitud_LED_FREC_tr0_tr0(const Ej3* handle)
{
	return handle->timeEvents.ej3_magnitud_LED_FREC_tev0_raised;
}

static sc_boolean check_magnitud_LED_VOLTAGE_tr0_tr0(const Ej3* handle)
{
	return handle->timeEvents.ej3_magnitud_LED_VOLTAGE_tev0_raised;
}
...
static void effect_forma_WAIT_SELEC_FORMA_tr0(Ej3* handle)
{
	exseq_forma_WAIT_SELEC_FORMA(handle);
	enseq_forma_SELECC_FORMA_default(handle);
}

static void effect_forma_FORMA_SELECCIONADA_tr0(Ej3* handle)
{
	exseq_forma_FORMA_SELECCIONADA(handle);
	enseq_forma_WAIT_SELEC_FORMA_default(handle);
}

static void effect_forma_SELECC_FORMA_tr0(Ej3* handle)
{
	exseq_forma_SELECC_FORMA(handle);
	enseq_forma_TRIANGULAR_default(handle);
}
...
static void effect_magnitud_ELEGIR_AMPLITUD_FREC_r1_AMPLITUD_SELECCIONADA_tr0(Ej3* handle)
{
	...
	enseq_magnitud_LED_FREC_default(handle);
}
...
static void effect_magnitud_ELEGIR_AMPLITUD_VOLTAGE_r1_AMPLITUD_SELECCIONADA_tr0(Ej3* handle)
{
	...
	enseq_magnitud_LED_VOLTAGE_default(handle);
}

static void effect_magnitud_LED_FREC_tr0(Ej3* handle)
{
	exseq_magnitud_LED_FREC(handle);
	enseq_magnitud_WAIT_SELECCION_MAGNITUD_default(handle);
}

static void effect_magnitud_LED_VOLTAGE_tr0(Ej3* handle)
{
	exseq_magnitud_LED_VOLTAGE(handle);
	enseq_magnitud_WAIT_SELECCION_MAGNITUD_default(handle);
}
...
/* Entry action for state 'WAIT_SELEC_FORMA'. */
static void enact_forma_WAIT_SELEC_FORMA(Ej3* handle)
{
	/* Entry action for state 'WAIT_SELEC_FORMA'. */
	handle->internal.viSetForma = bool_false;
...
{
	/* Entry action for state 'FORMA_SELECCIONADA'. */
	ej3_setTimer(handle, (sc_eventid) &(handle->timeEvents.ej3_forma_FORMA_SELECCIONADA_tev0_raised) , 50, bool_false);
	ej3Iface_opLED(handle, EJ3_EJ3IFACE_LEDR, EJ3_EJ3IFACE_LED_ON);
}
...
/* Entry action for state 'LED_FREC'. */
static void enact_magnitud_LED_FREC(Ej3* handle)
{
	/* Entry action for state 'LED_FREC'. */
	ej3_setTimer(handle, (sc_eventid) &(handle->timeEvents.ej3_magnitud_LED_FREC_tev0_raised) , 10, bool_false);
	ej3Iface_opLED(handle, EJ3_EJ3IFACE_LEDG, EJ3_EJ3IFACE_LED_ON);
}

/* Entry action for state 'LED_VOLTAGE'. */
static void enact_magnitud_LED_VOLTAGE(Ej3* handle)
{
	/* Entry action for state 'LED_VOLTAGE'. */
	ej3_setTimer(handle, (sc_eventid) &(handle->timeEvents.ej3_magnitud_LED_VOLTAGE_tev0_raised) , 10, bool_false);
	ej3Iface_opLED(handle, EJ3_EJ3IFACE_LEDB, EJ3_EJ3IFACE_LED_ON);
}
...
/* Exit action for state 'LED_FREC'. */
static void exact_magnitud_LED_FREC(Ej3* handle)
{
	/* Exit action for state 'LED_FREC'. */
	ej3_unsetTimer(handle, (sc_eventid) &(handle->timeEvents.ej3_magnitud_LED_FREC_tev0_raised) );		
}

/* Exit action for state 'LED_VOLTAGE'. */
static void exact_magnitud_LED_VOLTAGE(Ej3* handle)
{
	/* Exit action for state 'LED_VOLTAGE'. */
	ej3_unsetTimer(handle, (sc_eventid) &(handle->timeEvents.ej3_magnitud_LED_VOLTAGE_tev0_raised) );		
}
...
/* 'default' enter sequence for state WAIT_SELEC_FORMA */
static void enseq_forma_WAIT_SELEC_FORMA_default(Ej3* handle)
{
	/* 'default' enter sequence for state WAIT_SELEC_FORMA */
	enact_forma_WAIT_SELEC_FORMA(handle);
	handle->stateConfVector[2] = Ej3_forma_WAIT_SELEC_FORMA;
	handle->stateConfVectorPosition = 2;
}
...
/* 'default' enter sequence for state SELECC_FORMA */
static void enseq_forma_SELECC_FORMA_default(Ej3* handle)
{
	/* 'default' enter sequence for state SELECC_FORMA */
	handle->stateConfVector[2] = Ej3_forma_SELECC_FORMA;
	handle->stateConfVectorPosition = 2;
}
...
/* 'default' enter sequence for state LED_FREC */
static void enseq_magnitud_LED_FREC_default(Ej3* handle)
{
	/* 'default' enter sequence for state LED_FREC */
	enact_magnitud_LED_FREC(handle);
	handle->stateConfVector[3] = Ej3_magnitud_LED_FREC;
	handle->stateConfVectorPosition = 3;
}

/* 'default' enter sequence for state LED_VOLTAGE */
static void enseq_magnitud_LED_VOLTAGE_default(Ej3* handle)
{
	/* 'default' enter sequence for state LED_VOLTAGE */
	enact_magnitud_LED_VOLTAGE(handle);
	handle->stateConfVector[3] = Ej3_magnitud_LED_VOLTAGE;
	handle->stateConfVectorPosition = 3;
}
...
/* Default exit sequence for state WAIT_SELEC_FORMA */
static void exseq_forma_WAIT_SELEC_FORMA(Ej3* handle)
{
	/* Default exit sequence for state WAIT_SELEC_FORMA */
	handle->stateConfVector[2] = Ej3_last_state;
...
/* Default exit sequence for state SELECC_FORMA */
static void exseq_forma_SELECC_FORMA(Ej3* handle)
{
	/* Default exit sequence for state SELECC_FORMA */
	handle->stateConfVector[2] = Ej3_last_state;
...
/* Default exit sequence for state LED_FREC */
static void exseq_magnitud_LED_FREC(Ej3* handle)
{
	/* Default exit sequence for state LED_FREC */
	handle->stateConfVector[3] = Ej3_last_state;
	handle->stateConfVectorPosition = 3;
	exact_magnitud_LED_FREC(handle);
}

/* Default exit sequence for state LED_VOLTAGE */
static void exseq_magnitud_LED_VOLTAGE(Ej3* handle)
{
	/* Default exit sequence for state LED_VOLTAGE */
	handle->stateConfVector[3] = Ej3_last_state;
	handle->stateConfVectorPosition = 3;
	exact_magnitud_LED_VOLTAGE(handle);
}
...
/* The reactions of state WAIT_SELEC_FORMA. */
static void react_forma_WAIT_SELEC_FORMA(Ej3* handle)
{
	/* The reactions of state WAIT_SELEC_FORMA. */
	if (check_forma_WAIT_SELEC_FORMA_tr0_tr0(handle) == bool_true)
	{ 
		effect_forma_WAIT_SELEC_FORMA_tr0(handle);
	} 
}
...
/* The reactions of state SELECC_FORMA. */
static void react_forma_SELECC_FORMA(Ej3* handle)
{
	/* The reactions of state SELECC_FORMA. */
	if (check_forma_SELECC_FORMA_tr0_tr0(handle) == bool_true)
	{ 
		effect_forma_SELECC_FORMA_tr0(handle);
	}  else
	{
		if (check_forma_SELECC_FORMA_tr1_tr1(handle) == bool_true)
		{ 
			effect_forma_SELECC_FORMA_tr1(handle);
		} 
	}
}
...
static void react_magnitud_FRECUENCIA(Ej3* handle)
{
	...
	{
		if (check_magnitud_FRECUENCIA_tr1_tr1(handle) == bool_true)
		{ 
			effect_magnitud_FRECUENCIA_tr1(handle);
		} 
	}
}
...
static void react_magnitud_TENSION(Ej3* handle)
{
	...
	{
		if (check_magnitud_TENSION_tr1_tr1(handle) == bool_true)
		{ 
			effect_magnitud_TENSION_tr1(handle);
		} 
	}
}
...
/* The reactions of state LED_FREC. */
static void react_magnitud_LED_FREC(Ej3* handle)
{
	/* The reactions of state LED_FREC. */
	if (check_magnitud_LED_FREC_tr0_tr0(handle) == bool_true)
	{ 
		effect_magnitud_LED_FREC_tr0(handle);
	} 
}

/* The reactions of state LED_VOLTAGE. */
static void react_magnitud_LED_VOLTAGE(Ej3* handle)
{
	/* The reactions of state LED_VOLTAGE. */
	if (check_magnitud_LED_VOLTAGE_tr0_tr0(handle) == bool_true)
	{ 
		effect_magnitud_LED_VOLTAGE_tr0(handle);
	} 
}
