...
>Implementar (editar, simular) el modelo de control manual de ejes de CNC
>
> 1. Editar y simular
> 2. Generación de código
...
***
Código fuente: [ej8](ej8)

Se diseñó un control manual de 3 ejes de movimiento de una CNC. Cada eje puede moverse en ambos sentidos, a una sola velocidad. Se define que en todos los ejes existe un final de carrera.

Para hacer un poco más interactivo el ejercicio, si el final de carrera se activa en el movimiento de alguno de los ejes, se frenará el movimiento. El programa solo puede mover un eje a la vez.
